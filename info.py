...
API_ID = int(environ.get("API_ID", "24641196"))
API_HASH = environ.get("API_HASH", "4eccb2a779f567f7e506015b0163d857")
...
ADMINS = [
    ...
    for admin in environ.get("ADMINS", "7612214919").split()
]
...
CHANNELS = [
    ...
    for ch in environ.get("CHANNELS", "-1002708296315").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "0"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1002639215788"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002606709611"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "0"))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", "-1002639215788"))
...
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1002797450067"))

# Added Link Here Not Id
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/+D02ZgS0FHfFhMmQ9")
MOVIE_GROUP_LINK = environ.get("MOVIE_GROUP_LINK", "https://t.me/RSD_REQUEST_GROUP")
...
START_IMG = (
    environ.get(
        "START_IMG",
        "https://files.catbox.moe/b1xkpx.jpg",
    )
).split()
